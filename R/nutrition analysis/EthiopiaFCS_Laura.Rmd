...
# library(xtable)
library(knitr)
foodTable = data.frame(`food group` = c("cereals, tubers, crops", "pulses", "vegetables", "fruits", "protein", "milk", "sugar", "oil"), `food item` = c("enjera, other cereal, potatoes, pasta/biscuits", "beans, lentils, nuts", "vegetables","fruits",  "red meat, poultry, fish, eggs", "milk, cheese, other dairy", "sugar and sweets", "oils/fats/butter"), 
