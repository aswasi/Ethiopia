...
g byte dadbioPresent = hh_s1q12 == 1
g byte mombioPresent = hh_s1q16 == 1

la var dadbioPresent "Biological dad present in hh"
la var mombioPresent "Biological mom present in hh"
...
* Secondary 
replace educ = 5 if inlist(hh_s2q05, 11, 12, 25, 26, 27, 28, 29, 30, 13)
* Secondary 
replace educ = 6 if inlist(hh_s2q05, 14, 15, 16, 17, 18, 19, 31, 32, 33)
